 ...
 * 2016-04-04T17:26:56.254+02:00
 * Generated source version: 2.7.14.redhat-1
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://localhost:8080/pract1ServidorWeb/HelloWorld?wsdl",
...
public class HelloWorldService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/pract1ServidorWeb/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/pract1ServidorWeb/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
