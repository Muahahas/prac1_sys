...
public class ClientSample {
	...
	public static void main(String[] args) throws Exception {
        ...
        System.out.println("Server said: " + port1.getLogByDate("2016-05-20", "2016-05-21"));
        System.out.println("Server said: " + port1.getLogByDateAndTypeEvent("2016-05-20", "2016-05-21",7));
	...
	/*
	        ...
	        System.out.println("Server said: " + port2.getLogByDateAndTypeEvent(null,null,Integer.parseInt(args[7])));
	        //Please input the parameters instead of 'null' for the upper method!
	
	        System.out.println("Server said: " + port2.getTypesOfLocals());
	        System.out.println("Server said: " + port2.getLogByDate(null,null));
	        //Please input the parameters instead of 'null' for the upper method!
